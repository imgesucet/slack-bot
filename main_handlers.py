...
def handle_help_actions_func(ack, body, say):
    ...
    if help_topic == "datasets":
        ...
        say("Check frequently asked queries to see what other users have been quering  https://defytrends.gitbook.io/genie-ai-slack-bot/product-guides/f.a.q./queries Additionally, you can use the /suggest tool for inspiration on suggested questions to ask your data!")
    elif help_topic == "general":
        say("Here is our manual, where you can find setup instructions at this link: https://defytrends.gitbook.io/genie-ai-slack-bot . If you encounter an error or bug, please contact our support team at help@opengenie.on.spiceworks.com. Our dedicated technical agents will promptly create a ticket and go the extra mile to resolve your issue")
    else:
